...
async function testMoreSentences() {
  console.log('🧪 Testing Summarization with More Sentences...');
  ...
  try {
    ...
    // Test with longer text that should extract more sentences
    console.log('\n2. Testing with longer text for more sentences...');
