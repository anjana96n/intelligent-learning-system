export interface GradioSummaryResult {
  summary: string;
  confidence: number;
...
class GradioSummarizationService {
  private static instance: GradioSummarizationService;
  private isInitialized = false;
  private spaceUrl = "https://genailearniverse-textsummarizer.hf.space";
  private apiUrl = "https://genailearniverse-textsummarizer.hf.space/api/predict";

  private constructor() {}

  static getInstance(): GradioSummarizationService {
    if (!GradioSummarizationService.instance) {
      GradioSummarizationService.instance = new GradioSummarizationService();
    }
    return GradioSummarizationService.instance;
  }
  ...
  async summarize(text: string): Promise<GradioSummaryResult> {
  ...
  getStatus(): { isInitialized: boolean; spaceUrl: string; modelUsed: string } {
    return {
